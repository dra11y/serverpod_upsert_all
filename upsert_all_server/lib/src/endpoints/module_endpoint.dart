...
import '../extensions/chunked_list.dart';
import '../serverpod/format_table_row.dart';
import '../serverpod/log_query.dart';
...
class ModuleEndpoint extends Endpoint {
  Future<Map<UpsertReturnType, List<T>>> upsertAll<T extends TableRow>({
    ...
    Set<UpsertReturnType> returning = UpsertReturnTypes.changeTypes,
